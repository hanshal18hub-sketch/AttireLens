...
6. **Identity fidelity:** preserve the customer’s face, skin tone, hair, body shape, and chosen presentation.
...
“Nothing is stored” means no persistent storage. Processing still requires transient bytes in device or server memory.
